...
with DAG(
    ...
    extract_product_data = PythonOperator(
        task_id="extract_product_data", python_callable=scripts.extract_product_id.main
    )
    create_fact_table = PythonOperator(
        task_id="create_fact_table", python_callable=scripts.extract_product_id.main
    )
    create_dim_book_table = PythonOperator(
        task_id="create_dim_book_table", python_callable=scripts.extract_product_id.main
    )
